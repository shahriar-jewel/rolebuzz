                ...
                function i(e, t) {
                    ...
                    return e.nodeName
                        ? "img" !== e.nodeName.toLowerCase()
                            ? t(new Error("Element supplied is not an image"))
                            : e.src && e.complete && void 0 !== e.naturalWidth
                            ? t(null, !0)
                            : (i(e, "load", !0, n), i(e, "error", !0, n), (e.readyState || e.complete) && ((r = e.src), (e.src = s), (e.src = r)), void 0)
                        : t(new Error("First argument must be an image element"));
                }
            ...
            function (e, t) {
                ...
                (i.prototype.getImageSrcs = function (e) {
                    ...
                    (i.prototype.determineUrlAndType = function (e) {
                        ...
                        return (
                            ("undefined" != typeof s.backgroundImage && "" !== s.backgroundImage && "none" !== s.backgroundImage) ||
                            ("undefined" != typeof e.style.backgroundImage && "" !== e.style.backgroundImage && "none" !== e.style.backgroundImage)
                                ? ((t = s.backgroundImage || e.style.backgroundImage), (i = "background"))
                                : "undefined" != typeof e.getAttribute("src") && "img" === e.nodeName.toLowerCase() && (t = e.getAttribute("src")),
                            { url: t, type: i }
                        );
                    }),
            ...
            function (e, t) {
                ...
                (i.prototype.init = function () {
                    ...
                    this.create(),
                        ...
                        this.showPercentage &&
                            ((this.percentage = new n()), (this.percentage.barColor = this.barColor), (this.percentage.idName = this.percentageId), this.percentage.create(), this.element.appendChild(this.percentage.element)),
                    ...
                    (i.prototype.calculatePosition = function () {
                        ...
                        return (
                            "body" === this.parentElement.tagName.toLowerCase()
                                ? (e = "fixed")
                                : ("fixed" !== this.parentElement.style.position || "absolute" !== this.parentElement.style.position) && (this.parentElement.style.position = "relative"),
                            e
                        );
                    }),
                    (i.prototype.updateProgress = function (e, t) {
            ...
            function (e, t) {
                ...
                (i.prototype.init = function () {
                    ...
                    (i.prototype.updateProgress = function (e, t) {
                        "use strict";
                        var i = (e / t) * 100;
                        this.overlay.updateProgress(i, this.options.minimumTime),
                            "function" == typeof this.options.onProgress && this.options.onProgress(i, e, t),
